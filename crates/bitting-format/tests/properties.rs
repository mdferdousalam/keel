...
use bitting_crypto::{
    subkeys, Key256, SecretBytes, AEAD_ID_XCHACHA20POLY1305, KDF_ID_ARGON2ID_V13,
};
...
prop_compose! {
    fn arb_header()(
        ...
        let wrapped_keys = (0..epoch_count)
            .map(|i| WrappedKey {
                epoch: i as u32,
                nonce: [i as u8; bitting_crypto::NONCE_LEN],
...
proptest! {
    ...
    fn header_decode_never_panics_with_valid_magic(
        ...
        let mut bytes = bitting_format::MAGIC.to_vec();
