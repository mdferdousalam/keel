...
pub const DOMAIN_INDEX: &[u8] = b"bitting/v1/index";
/// Prefix for per-record keys; completed with the record id and key epoch.
pub const DOMAIN_RECORD_PREFIX: &[u8] = b"bitting/v1/record/";
/// Audit-log encryption and chaining key.
pub const DOMAIN_AUDIT: &[u8] = b"bitting/v1/audit";
/// Prefix for per-attachment keys.
pub const DOMAIN_ATTACH_PREFIX: &[u8] = b"bitting/v1/attach/";
/// Root from which browser-extension and MCP-client pairing keys are derived.
pub const DOMAIN_PAIRING_ROOT: &[u8] = b"bitting/v1/pairing-root";
...
pub const DOMAIN_SEARCH: &[u8] = b"bitting/v1/search";
