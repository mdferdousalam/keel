...
//! The Bitting browser native-messaging bridge.
//!
//! Thin by design; see [`bitting_native_host`] for what this process is and, more importantly,
...
fn main() -> std::process::ExitCode {
    match bitting_native_host::run() {
        ...
        Err(error) => {
            ...
            eprintln!("bitting-native-host: {error}");
